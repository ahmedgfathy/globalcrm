...
export default function PropertyInformations({
  ...
  const fieldsData = [
    {
      ...
      idField: 'property_number',
      defaultValue: page !== 'add' ? 'PRO3722' : '',
    },
    {
      id: 2,
      type: 'input',
    ...
    },
    {
      ...
      label: 'Unit For',
      idField: 'unit_for',
      defaultValue: page !== 'add' ? 'For Rent' : '',
    },
    {
      id: 4,
      type: 'select',
      label: 'Area',
      idField: 'area',
      defaultValue: page !== 'add' ? 'NARGS VILLAS' : '',
      options: [
    ...
    },
    {
      ...
      label: 'Finished',
      idField: 'Finished',
      defaultValue: page !== 'add' ? 'FULLY FINISHED' : '',
      options: [
    ...
    },
    {
      ...
      label: 'Total Price',
      idField: 'Total Price',
      defaultValue: page !== 'add' ? '3000' : '',
    },
    {
      id: 4,
      type: 'date',
      label: 'Last_Follow_up',
      idField: 'LastFollowUp',
      defaultValue: page !== 'add' ? '2022-08-30' : '',
    },
    {
      id: 5,
      type: 'textarea',
      label: 'descriptions',
      idField: 'descriptions',
      defaultValue: page !== 'add' ? '...' : '',
    },
    {
      id: 6,
  ...
  return (
    <Card className='menu-drawer w-full min-h-screen h-max bg-Lightbg dark:bg-cardbgDark shadow-box_shadow dark:shadow-none py-8 max-md:pt-4'>
      ...
      <CardContent
        className='lg:grid gap-6 lg:grid-cols-4 md:gap-8 max-sm:flex max-sm:flex-col-reverse'
        dir='rtl'
      >
