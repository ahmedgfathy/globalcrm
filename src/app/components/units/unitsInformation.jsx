...
export default function UnitsInformation({
  ...
  const fieldsData = [
    {
      id: 25,
      type: 'input',
      label: 'property_name_compound_name',
      idField: 'compoundName',
      defaultValue: props?.unit?.compoundName,
      required: true,
    },
    {
      id: 1,
      ...
      defaultValue: props?.unit?.propertyNumber,
    },
    {
      id: 17,
      type: 'input',
      label: 'unit_no',
      idField: 'unitNo',
      defaultValue: props?.unit?.unitNo,
    },
    {
      id: 2,
      type: 'select',
    ...
    },
    {
      ...
      idField: 'building',
      defaultValue: props?.unit?.building,
    },
    {
      id: 8,
      type: 'multiselect',
    ...
    },
    {
      ...
      type: 'input',
      label: 'props_of_unit',
      idField: 'unitFeatures',
      defaultValue: props?.unit?.unitFeatures,
    },
    {
      id: 11,
      type: 'select',
    ...
    },
    {
      ...
      label: 'total_price',
      idField: 'totalPrice',
      defaultValue: props?.unit?.totalPrice,
    },
    {
      id: 24,
      type: 'input',
      label: 'Meter price',
      idField: 'PricePerMeter',
      defaultValue: props?.unit?.PricePerMeter,
    },
    {
      id: 21,
      type: 'select',
    ...
    },
    {
      ...
      idField: 'lastFollowIn',
      defaultValue: props?.unit?.lastFollowIn,
    },
    {
      id: 15,
      type: 'select',
    ...
    },
    {
      ...
      label: 'status',
      idField: 'status',
      defaultValue: props?.unit?.status,
    },

    {
      ...
      label: 'rent_from',
      idField: 'rentFrom',
      defaultValue: props?.unit?.rentFrom,
    },
    {
      id: 23,
      type: 'date',
      label: 'rent_to',
      idField: 'rentTo',
      defaultValue: props?.unit?.rentTo,
    },
    {
      id: 20,
      type: 'input',
      label: 'land_area',
      idField: 'landArea',
      defaultValue: props?.unit?.landArea,
    },
    {
      id: 18,
      type: 'date',
      label: 'created_time',
      idField: 'createdTime',
      defaultValue: props?.unit?.createdTime,
    },
    {
      id: 19,
      type: 'date',
      label: 'modified_time',
      idField: 'modifiedTime',
      defaultValue: props?.unit?.modifiedTime,
    },
    {
      id: 13,
      type: 'textarea',
      label: 'descriptions',
      idField: 'description',
      defaultValue: props?.unit?.description,
    },
  ]
  ...
  return (
    <Card className='menu-drawer w-full h-max bg-Lightbg dark:bg-cardbgDark shadow-box_shadow dark:shadow-none py-4 overflow-x-hidden'>
      ...
      />
      <CardContent
        className='w-full overflow-x-hidden d gap-2 gap-y-8 md:gap-3 max-sm:flex max-sm:flex-col-reverse pt-4'
        dir='rtl'
      >
        <FormFields
          fields={fieldsData}
